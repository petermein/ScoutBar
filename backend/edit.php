...
<div class="wrapper content">
  ...
  <div class="box">
    <!--Begin Login Header-->
    <div class="header">
      <p><img src="images/half_width_icon.png" alt="Half Width Box" width="30" height="30" />Bewerk bericht</p>
    </div>
    <!--End Login Header-->
    <div class="body">
...
$sql = "UPDATE `news_ticker` SET  `bericht` =  '{$_POST['bericht']}'   WHERE `id` = '$id' "; 
mysql_query($sql) or die(mysql_error()); 
echo (mysql_affected_rows()) ? "Edited row.<br />" : "Nothing changed. <br />"; 
echo "<a href='index.php'>Back To Listing</a>"; 
} 
$row = mysql_fetch_array ( mysql_query("SELECT * FROM `news_ticker` WHERE `id` = '$id' ")); 
?>
<form action='' method='POST'> 
<p><b>Bericht:</b><br /><textarea name='bericht'><?= stripslashes($row['bericht']) ?></textarea> </p>
